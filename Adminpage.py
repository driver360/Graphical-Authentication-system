...
try:
    ...
    class Graph_Home(tk.Frame):
        def __init__(self, parent, controller):
            ...
            try:
                ...
                H_lbl_phase1 = Label(H_Right_Canvas, text="REGISTRATION PHASE", bg="#C3F74A", fg="red",
                ...
                H_lbl_phase2 = Label(H_Right_Canvas, text="LOGIN PHASE", bg="#C3F74A", fg="red",
                                     font=("Courier New", 15, "bold"))
                ...
                H_lbl_phase3 = Label(H_Right_Canvas, text="ABOUT US PHASE", bg="#C3F74A", fg="red",
                                     font=("Courier New", 15, "bold"))
                ...
                H_lbl_phase4 = Label(H_Right_Canvas, text="ADMIN PHASE", bg="#C3F74A", fg="red",
                                     font=("Courier New", 15, "bold"))
                ...
                H_lbl_phase5 = Label(H_Right_Canvas, text="EXIT PHASE", bg="#C3F74A", fg="red",
                                     font=("Courier New", 15, "bold"))
                ...
                H_reg_btn = Button(self, text="REGISTRATION",
                                   command=lambda: controller.show_frame("Graph_Registration"), bg="#4A8AF7",
                                   font=("times new roman", 15, "bold")).place(x=740, y=150)
                H_log_btn = Button(self, text="         LOGIN        ", fg="black",
                                   command=lambda: controller.show_frame("Graph_Autentication"), bg="#4A8AF7",
                                   font=("times new roman", 15, "bold")).place(x=740, y=260)
                H_abt_btn = Button(self, text="     ABOUT US     ", command=self.H_About_Function,
                                   font=("times new roman", 15, "bold"), bg="#4A8AF7").place(x=740, y=370)
                H_admin_btn = Button(self, text="        ADMIN        ",command=lambda: controller.show_frame("Graph_Admin"), font=("times new roman", 15, "bold"),
                                     bg="#4A8AF7").place(x=740, y=480)
                H_exit_btn = Button(self, text="          EXIT          ", font=("times new roman", 15, "bold"),
                                    bg="#4A8AF7", command=self.close_window).place(x=740, y=590)
    ...
    class Graph_Registration(tk.Frame):
        def __init__(self, parent, controller):
            ...
            R_title = tk.Label(self, text="New User Registration", bd=10, relief=GROOVE,
                               font=("times new roman", 40, "bold"), bg="#006666", fg="white", )
            ...
            try:
                ...
                R_Registration_title = tk.Label(self.R_Left_Canvas, text="REGISTRATION PROCESS", pady=0, bg="#C79408",
                                                fg="black", font=("times new roman", 18, "bold"))
                ...
                R_lbl_name = tk.Label(self.R_Left_Canvas, text="NAME", bg="#C79408", fg="black",
                                      font=("times new roman", 15, "bold"))
                R_lbl_name.place(x=20, y=55, width=65, height=22)
                R_txt_name = tk.Entry(self.R_Left_Canvas, textvariable=self.R_name_var, width=25,
                                      font=("times new roman", 15, ""), bd=2, relief=GROOVE)
                R_txt_name.place(x=90, y=52)

                R_lbl_email = tk.Label(self.R_Left_Canvas, text="EMAIL", bg="#C79408", fg="black",
                                       font=("times new roman", 15, "bold"))
                R_lbl_email.place(x=20, y=88, width=68, height=22)
                R_txt_email = tk.Entry(self.R_Left_Canvas, width=25, font=("times new roman", 15, ""),
                                       textvariable=self.R_email_var, bd=2, relief=GROOVE)
                R_txt_email.place(x=90, y=85)

                R_lbl_mob = tk.Label(self.R_Left_Canvas, text="CONTACT", bg="#C79408", fg="black",
                                     font=("times new roman", 15, "bold"))
                R_lbl_mob.place(x=20, y=121, height=22)
                R_txt_mob = tk.Entry(self.R_Left_Canvas, width=21, font=("times new roman", 15, ""),
                                     textvariable=self.R_contact_var, bd=2, relief=GROOVE)
                R_txt_mob.place(x=130, y=118)

                R_lbl_pts = tk.Label(self.R_Left_Canvas, text="CUE POINTS COLLECTED", bg="#C79408", fg="black",
                                     font=("times new roman", 15, "bold"))
                ...
                R_forgot_title = tk.Label(self.R_Left_Canvas, text="FORGOT PASSWORD", pady=0, bg="#C79408", fg="black",
                ...
                R_lbl_ques = tk.Label(self.R_Left_Canvas, text="CUSTOM QUESTION", bg="#C79408", fg="black",
                                      font=("times new roman", 15, "bold"))
                R_lbl_ques.place(x=20, y=318)
                R_txt_ques = tk.Entry(self.R_Left_Canvas, textvariable=self.R_question_var, width=40,
                                      font=("times new roman", 15, ""), bd=2, relief=GROOVE)
                R_txt_ques.place(x=20, y=345)

                R_lbl_ans = tk.Label(self.R_Left_Canvas, text="CUSTOM ANSWER", bg="#C79408", fg="black",
                                     font=("times new roman", 15, "bold"))
                R_lbl_ans.place(x=20, y=375)
                R_txt_ans = tk.Entry(self.R_Left_Canvas, textvariable=self.R_answer_var, width=40,
                                     font=("times new roman", 15, ""), bd=2, relief=GROOVE)
                R_txt_ans.place(x=20, y=402)

                R_lbl_register = tk.Label(self.R_Left_Canvas, text="REGISTER\nTO DB", bg="#C79408", fg="black",
                                          font=("Franklin Gothic Book", 12, "bold"))
                R_lbl_register.place(x=29, y=452, width=104, height=44)
                R_register_btn = tk.Button(self.R_Left_Canvas, text="REGISTER", command=self.registerfn,
                                           font=("times new roman", 15, "bold")).place(x=135, y=454)

                R_lbl_save = tk.Label(self.R_Left_Canvas, text="SAVE", bg="#C79408", fg="black",
                                      font=("Franklin Gothic Book", 15, "bold"))
                R_lbl_save.place(x=350, y=459, width=60)
                R_save_btn = tk.Button(self.R_Left_Canvas, text="SAVE", command=self.collection,
                                       font=("times new roman", 15, "bold")).place(x=425, y=454)

                R_reset_btn = tk.Button(self, text="RESET", command=self.clear, bg="#FF6666",
                                        font=("times new roman", 15, "bold")).place(x=593, y=543)
                # =========Image Canvas===========================

                self.R_Image_Canvas = tk.Canvas(self, bd=4, relief=RIDGE, bg="#B999FA")
                self.R_Image_Canvas.place(x=715, y=90, width=637, height=512)

                R_Image_title = tk.Label(self.R_Image_Canvas, text="IMAGE", bg="#B999FA", fg="black",
                ...
                R_lbl_load_pic = Label(R_Bottom_Canvas, text="LOAD\nPICTURE", bg="#1E90FF", fg="white",
                                       font=("times new roman", 12, "bold"))
                R_lbl_load_pic.place(x=70, y=15, width=75, height=44)

                R_load_pic_btn = Button(R_Bottom_Canvas, text="LOAD PIC", command=self.fileDialog,
                                        font=("times new roman", 15, "bold")).place(x=155, y=17)

                R_lbl_cue = Label(R_Bottom_Canvas, text="CUE\nPOINTS", bg="#1E90FF", fg="black",
                                  font=("times new roman", 13, "bold"))
                R_lbl_cue.place(x=563, y=15, width=67, height=44)

                R_lbl_points = Label(R_Bottom_Canvas, textvariable=self.R_mousePosition, bd=3, relief=RIDGE, bg="white",
                                     fg="black", font=("times new roman", 18, "bold"))
                R_lbl_points.place(x=640, y=15, width=150, height=45)

                R_lbl_exit = Label(R_Bottom_Canvas, text="EXIT TO\nMAIN MENU", bg="#1E90FF", fg="white",
                                   font=("times new roman", 12, "bold"))
                R_lbl_exit.place(x=1066, y=15, width=104, height=44)

                R_cancel_btn = Button(R_Bottom_Canvas, text="CANCEL", fg="black",
                                      command=lambda: controller.show_frame("Graph_Home"), bg="white",
                                      font=("times new roman", 15, "bold")).place(x=1180, y=17)
        ...
        def registerfn(self):
            ...
            if (self.R_image_count_var[0] != 0 and self.R_image_count_var[1] != 0 and self.R_image_count_var[
                2] != 0 and self.R_name_var != "" and self.R_email_var != "" and self.R_question_var != "" and self.R_answer_var != ""):
                query = "insert into registration_table(name,email,contact,question,answer,p1,p2,p3) values(%s,%s,%s,%s,%s,%s,%s,%s)"
                val = (
                self.R_name_var.get(), self.R_email_var.get(), self.R_contact_var.get(), self.R_question_var.get(),
                self.R_answer_var.get(), self.R_path_list_var[0], self.R_path_list_var[1], self.R_path_list_var[2])
        ...
        def clear(self):
            if (self.R_image_count_var[0] == 0 and self.R_image_count_var[1] == 0 and self.R_image_count_var[
                2] == 0 and self.i == 0 and self.R_point_count_var == 0 and self.R_name_var == "" and self.R_email_var == "" and self.R_contact_var == "" and self.R_question_var == "" and self.R_answer_var == "" and self.filename == "" and self.R_cues_var == "" and self.R_mousePosition == ""):
    ...
    class Graph_Autentication(tk.Frame):
        def __init__(self, parent, controller):
            ...
            A_title = tk.Label(self, text="User Authentication", bd=10, relief=GROOVE,
                               font=("times new roman", 40, "bold"), bg="#610351", fg="white", )
            ...
            self.j = 0
            self.k = 0
            self.imgs = ["S:/background-1992153_1920.jpg", "S:/background-378781_1920.jpg", "S:/bg2.jpg", "S:/bg3.jpg",
                         "S:/black-2398956_1920.jpg", "S:/background-378781_1920.jpg"]
            try:
                # =========Register Canvas===========================
                ...
                A_lbl_email = Label(self.A_Left_Canvas, text="EMAIL", bg="#33FF77", fg="black",
                                    font=("times new roman", 19, "bold"))
                A_lbl_email.place(x=20, y=50)
                A_txt_email = Entry(self.A_Left_Canvas, textvariable=self.A_email_var, width=30,
                                    font=("times new roman", 15, "bold"), bd=5, relief=GROOVE)
                A_txt_email.place(x=120, y=50)

                self.A_verify_btn = Button(self.A_Left_Canvas, command=self.Verify_Function, text="Verify",
                                           font=("times new roman", 15, "bold")).place(x=160, y=98)
                self.A_proceed_btn = Button(self.A_Left_Canvas, text="Proceed", command=self.Proceed_Function,
                                            font=("times new roman", 15, "bold")).place(x=300, y=98)
                # self.A_proceed_btn.state=NORMAL
                A_lbl_feedback = Label(self.A_Left_Canvas, text="FEEDBACK METHODS", bg="#33FF77", fg="black",
                ...
                A_immediate_radio_btn = tk.Radiobutton(self.A_Left_Canvas, text="IMMEDIATE FEEDBACK", variable=self.A_v,
                                                       value=1, bg="#33FF77", fg="crimson",
                ...
                A_knowledge_radio_btn = tk.Radiobutton(self.A_Left_Canvas, text="KNOWLEDGE BASED FEEDBACK",
                                                       variable=self.A_v, value=2, bg="#33FF77", fg="crimson",
                                                       font=("Franklin Gothic Book", 14, "bold"))
                ...
                A_Image_title = tk.Label(self.A_Image_Canvas, text="IMAGE", bg="#F04BA9", fg="black",
                                         font=("times new roman", 25, "bold"))
                ...
                A_lbl_forgot_password = Label(A_Bottom_Canvas, text="FORGOT\nPASSWORD", bg="#1E90FF", fg="white",
                                              font=("times new roman", 12, "bold"))
                A_lbl_forgot_password.place(x=60, y=15, width=104, height=44)

                A_forgot_password_btn = Button(A_Bottom_Canvas, text="PASSWORD", command=self.Forgot_Function,
                                               font=("times new roman", 15, "bold")).place(x=165, y=17)

                A_lbl_exit = Label(A_Bottom_Canvas, text="EXIT TO\nMAIN MENU", bg="#1E90FF", fg="white",
                                   font=("times new roman", 12, "bold"))
                A_lbl_exit.place(x=1066, y=15, width=104, height=44)

                A_cancel_btn = Button(A_Bottom_Canvas, text="CANCEL", fg="black",
                                      command=lambda: controller.show_frame("Graph_Home"), bg="white",
                                      font=("times new roman", 15, "bold")).place(x=1180, y=17)
        ...
        def A_fileDialog(self, pts):
            ...
            if (len(ob2.datalist) != 0):
                ...
                self.st2 = self.st2[
                           self.st2.index(" ", len(st) + 6, len(self.st2)) + 1:self.st2.rindex(" ", len(st) + 6,
                                                                                               len(self.st2))]
                print(self.st2)
        ...
        def A_printcoords(self, event):
            ...
            print(event.y)
            self.k = self.k + 1
            if (event.x >= int(self.st1) - 10 and event.x <= int(self.st1) + 10 and event.y >= int(
                    self.st2) - 10 and event.y <= int(self.st2) + 10 and self.k == 1):
                self.R_img.destroy()
                p = "p2"
                self.A_fileDialog(p)
            elif (event.x >= int(self.st1) - 10 and event.x <= int(self.st1) + 10 and event.y >= int(
                    self.st2) - 10 and event.y <= int(self.st2) + 10 and self.k == 2):
                self.R_img.destroy()
                p = "p3"
                self.A_fileDialog(p)
            elif (event.x >= int(self.st1) - 10 and event.x <= int(self.st1) + 10 and event.y >= int(
                    self.st2) - 10 and event.y <= int(self.st2) + 10 and self.k == 3):
    ...
    class Graph_Updation(tk.Frame):
        def __init__(self, parent, controller):
            ...
            Graph_Functions.G_upload_image(self, "bg7.jpg", 1366, 700, self, -2, 0)
            U_title = tk.Label(self, text="User's Details Updation", bd=10, relief=GROOVE,
                               font=("times new roman", 40, "bold"), bg="#006666", fg="white", )
            ...
            try:
                ...
                U_Updation_title = tk.Label(self.U_Left_Canvas, text="UPDATION PROCESS", pady=0, bg="#C79408",
                                            fg="black", font=("times new roman", 18, "bold"))
                ...
                U_lbl_name = tk.Label(self.U_Left_Canvas, text="NAME", bg="#C79408", fg="black",
                                      font=("times new roman", 15, "bold"))
                U_lbl_name.place(x=20, y=55, width=65, height=22)
                U_txt_name = tk.Entry(self.U_Left_Canvas, textvariable=self.U_name_var, width=25,
                                      font=("times new roman", 15, ""), bd=2, relief=GROOVE)
                U_txt_name.place(x=90, y=52)

                U_lbl_email = tk.Label(self.U_Left_Canvas, text="EMAIL", bg="#C79408", fg="black",
                                       font=("times new roman", 15, "bold"))
                U_lbl_email.place(x=20, y=88, width=68, height=22)
                U_txt_email = tk.Entry(self.U_Left_Canvas, width=25, font=("times new roman", 15, ""),
                                       textvariable=self.U_email_var, bd=2, relief=GROOVE)
                U_txt_email.place(x=90, y=85)

                U_lbl_mob = tk.Label(self.U_Left_Canvas, text="CONTACT", bg="#C79408", fg="black",
                                     font=("times new roman", 15, "bold"))
                U_lbl_mob.place(x=20, y=121, height=22)
                U_txt_mob = tk.Entry(self.U_Left_Canvas, width=21, font=("times new roman", 15, ""),
                                     textvariable=self.U_contact_var, bd=2, relief=GROOVE)
                U_txt_mob.place(x=130, y=118)

                U_lbl_pts = tk.Label(self.U_Left_Canvas, text="CUE POINTS COLLECTED", bg="#C79408", fg="black",
                                     font=("times new roman", 15, "bold"))
                ...
                U_forgot_title = tk.Label(self.U_Left_Canvas, text="FORGOT PASSWORD", pady=0, bg="#C79408", fg="black",
                                          font=("times new roman", 18, "bold"))
                ...
                U_lbl_ques = tk.Label(self.U_Left_Canvas, text="CUSTOM QUESTION", bg="#C79408", fg="black",
                                      font=("times new roman", 15, "bold"))
                U_lbl_ques.place(x=20, y=318)
                U_txt_ques = tk.Entry(self.U_Left_Canvas, textvariable=self.U_question_var, width=40,
                                      font=("times new roman", 15, ""), bd=2, relief=GROOVE)
                U_txt_ques.place(x=20, y=345)

                U_lbl_ans = tk.Label(self.U_Left_Canvas, text="CUSTOM ANSWER", bg="#C79408", fg="black",
                                     font=("times new roman", 15, "bold"))
                U_lbl_ans.place(x=20, y=375)
                U_txt_ans = tk.Entry(self.U_Left_Canvas, textvariable=self.U_answeU_var, width=40,
                                     font=("times new roman", 15, ""), bd=2, relief=GROOVE)
                ...
                U_update_btn = tk.Button(self.U_Left_Canvas, text="UPDATE", command=self.registerfn,
                                         font=("times new roman", 15, "bold")).place(x=135, y=454)

                U_lbl_save = tk.Label(self.U_Left_Canvas, text="SAVE", bg="#C79408", fg="black",
                                      font=("Franklin Gothic Book", 15, "bold"))
                U_lbl_save.place(x=350, y=459, width=60)
                U_save_btn = tk.Button(self.U_Left_Canvas, text="SAVE", command=self.collection,
                                       font=("times new roman", 15, "bold")).place(x=425, y=454)

                U_reset_btn = tk.Button(self, text="RESET", command=self.clear, bg="#FF6666",
                                        font=("times new roman", 15, "bold")).place(x=593, y=543)
                # =========Image Canvas===========================
                ...
                U_Image_title = tk.Label(self.U_Image_Canvas, text="IMAGE", bg="#B999FA", fg="black",
                                         font=("times new roman", 25, "bold"))
                ...
                U_load_pic_btn = Button(U_Bottom_Canvas, text="LOAD PIC", command=self.fileDialog,
                                        font=("times new roman", 15, "bold")).place(x=155, y=17)
                ...
                U_lbl_points = Label(U_Bottom_Canvas, textvariable=self.U_mousePosition, bd=3, relief=RIDGE, bg="white",
                                     fg="black", font=("times new roman", 18, "bold"))
                ...
                U_cancel_btn = Button(U_Bottom_Canvas, text="CANCEL", fg="black",
                                      command=lambda: controller.show_frame("Graph_Home"), bg="white",
                                      font=("times new roman", 15, "bold")).place(x=1180, y=17)
        ...
        def registerfn(self):
            ...
            if (self.U_image_count_var[0] != 0 and self.U_image_count_var[1] != 0 and self.U_image_count_var[
                2] != 0 and self.U_name_var != "" and self.U_email_var != "" and self.U_question_var != "" and self.U_answeU_var != ""):
                query = "insert into registration_table(name,email,contact,question,answer,p1,p2,p3) values(%s,%s,%s,%s,%s,%s,%s,%s)"
                val = (
                self.U_name_var.get(), self.U_email_var.get(), self.U_contact_var.get(), self.U_question_var.get(),
                self.U_answeU_var.get(), self.U_path_list_var[0], self.U_path_list_var[1], self.U_path_list_var[2])
                is_success = ob.universal_Transact(query, val)
            if is_success == 1:
                messagebox.showinfo("GAS", "done")
            else:
        ...
        def clear(self):
            if (self.U_image_count_var[0] == 0 and self.U_image_count_var[1] == 0 and self.U_image_count_var[
                2] == 0 and self.i == 0 and self.U_point_count_var == 0 and self.U_name_var == "" and self.U_email_var == "" and self.U_contact_var == "" and self.U_question_var == "" and self.U_answeU_var == "" and self.filename == "" and self.U_cues_var == "" and self.U_mousePosition == ""):
                messagebox.showerror("Error", "All Fields are already Empty!!!")
            else:
    ...
    class Graph_Admin(tk.Frame):
        def __init__(self, parent, controller):
            ...
            try:
                ...
                Am_cancel_btn = tk.Button(self, text="Cancel",
